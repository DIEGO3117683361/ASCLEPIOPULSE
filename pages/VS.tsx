...
import { Plus, Swords, Flame, Gamepad2, ArrowRight } from 'lucide-react';
...
const VS: React.FC = () => {
    ...
    return (
        <div className="p-4 space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-graphite-light p-4 rounded-xl shadow-lg border border-purple-500/30">
                <div className="flex items-center justify-between mb-3">
                    <div>
                        <h2 className="text-lg font-bold text-white">Minijuegos</h2>
                        <p className="text-sm text-purple-400 flex items-center">
                            <Gamepad2 size={14} className="mr-1"/> Desafíos rápidos
                        </p>
                    </div>
                </div>
                <p className="text-sm text-gray-300 mb-4">Perfectos para jugar entre series y mantener la mente activa. ¡Pon a prueba tus reflejos!</p>
                <Link to={`/minigames`} className="block w-full text-center bg-purple-500 text-white font-bold py-3 rounded-lg transition hover:bg-purple-600 flex items-center justify-center">
                   Ir a la Biblioteca de Juegos <ArrowRight size={16} className="ml-2"/>
                </Link>
            </div>

            <div className="flex justify-between items-center pt-4">
                 <h2 className="text-xl font-bold text-white flex items-center"><Swords className="mr-2 text-accent-lime"/> Tus Pulses</h2>
