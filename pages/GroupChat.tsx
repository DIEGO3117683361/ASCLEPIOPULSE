...
import { ArrowLeft, Send, Smile, Settings } from 'lucide-react';
...
const GroupChat: React.FC = () => {
    ...
    const { currentUser, users, getGroupChatMessages, sendGroupChatMessage, markGroupChatAsRead, groupChatRooms } = useUser();
