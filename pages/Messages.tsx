...
import { ChatRoom, GroupChatRoom } from '../types';
...
// FIX: Combine chat and group chat rooms into a single array and use a type guard for rendering.
    const combinedChats: (ChatRoom | GroupChatRoom)[] = [
        ...chatRooms,
        ...groupChatRooms
